omia3 = function(xy)
{
  ...
  if (scenario==1)	{
    prtox=c(0.1,0.2,0.3)	
    prsucc=c(0.09,0.24,0.56)	#k>=2:0.18,0.48,0.63 k=3:0.09,0.24,0.56
  }
  if (scenario==2)	{
    prtox=c(0.15,0.3,0.45)	
    prsucc=c(0.0425,0.07,0.4125)  #k>=2:0.2125,0.28,0.5225 k=3:0.0425,0.07,0.4125
  }
  if (scenario==3)	{
    prtox=c(0.2,0.4,0.7)
    prsucc=c(0.08,0.36,0.24)  #k>=2:0.24,0.54,0.27 k=3:0.08,0.36,0.24
  }
  ...
  besttrt=order(respmat[,2]*ind*toltox/(trials+0.00001))[maxdose]
